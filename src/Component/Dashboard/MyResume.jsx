...
const MyResume = () => {
  ...
  const [hoveredResumeId, setHoveredResumeId] = useState(null); // Track the hovered resume ID
                  ...
                  <td className="py-2 px-4 ">
                    ...
                    {hoveredResumeId === resume.id && (
                      <div
                        ...
                        onMouseEnter={() => setHoveredResumeId(resume.id)} // Keep it open while hovering over the dropdown
                        onMouseLeave={() => setHoveredResumeId(null)} // Close it when the user leaves
                      >
