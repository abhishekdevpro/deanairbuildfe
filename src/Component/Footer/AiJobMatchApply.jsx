...
function AiJobMatchApply() {
  return (
    <div className="m-10 mx-40 p-5  shadow-2xl">
      ...
      At Perfect Resume, we aim to make your job search efficient and effective
      ...
      Sign up on the Perfect Resume platform and create your profile. Upload
      ...
      Transform your job search with Perfect Resume’s AI Job Match & Apply tool.
