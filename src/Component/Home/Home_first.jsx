...
function Home_first() {
  ...
  return (
    ...
    <div className='flex justify-center'>  <a href="tel:+1 8887936474" className="text-black bg-red-300 px-3 py-4  rounded-3xl  font-bold text-center sm:hidden ">Call us 📞 +1 8887936474 </a></div>
