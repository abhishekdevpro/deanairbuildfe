...
function Home_Second() {
    ...
    const handleChoosePlan3 = () => {
      ...
      const isTestUser = email === 'testuser@gmail.com'
        ...
        <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
          ...
          <div className="space-y-4 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
            ...
            <div className="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
              ...
              <p className="font-light text-gray-500 sm:text-lg dark:text-gray-200">Relevant for multiple users, extended &amp; premium support.</p>
            ...
            <div className="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
              ...
              <p className="font-light text-gray-500 sm:text-lg dark:text-gray-200">Best for large scale uses and extended redistribution rights.</p>
              <div className="flex justify-center items-baseline my-8">
